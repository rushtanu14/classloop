...
const operatorModes = [
  ...
  ["Computer Use", "Native Swift macOS app, Electron Windows/Linux apps, installers, OS dialogs, file picker, microphone/screen-capture prompts, and clean-machine launch."],
...
const sections = [
  [
    ...
    [
      ...
      "On matching clean hosts (Swift macOS arm64, Windows x64/arm64, Linux x64/arm64), capture screenshots of the OS trust prompt and the first-run dashboard after launching the installer.",
